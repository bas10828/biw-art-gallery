...
const jsonLd = {
  ...
  creator: {
    "@type": "Person",
    name: "อักษรวิจิตร หงษ์ตัน",
    alternateName: ["บิว โคตรเสียว", "บิวโคตรเสียว", "khodseaw", "Biw"],
    jobTitle: "จิตรกร",
    nationality: "Thai",
    description:
      "ศิลปินร่วมสมัยชาวไทย ผู้สำรวจความสัมพันธ์ระหว่างมนุษย์กับธรรมชาติผ่านภาพต้นไม้ ป่าไม้ และภูมิทัศน์ทางอารมณ์ สร้างสรรค์ด้วยสีน้ำมันและสีอะคริลิกบนผ้าใบ",
    sameAs: [
    ...
    <>
      ...
      <section className="max-w-5xl mx-auto px-6 pb-24">
        ...
        >
          ...
          <div className="relative w-full md:w-1/2 min-h-72">
            <Image
              ...
              alt="อักษรวิจิตร หงษ์ตัน (บิว โคตรเสียว) ในแกลเลอรี"
              fill
          ...
          <div className="flex flex-col justify-center px-8 py-10 md:w-1/2 gap-4">
            ...
            <p className="text-ink2 text-sm leading-relaxed">
              ศิลปินร่วมสมัยชาวไทย ผู้สำรวจความสัมพันธ์ระหว่างมนุษย์กับธรรมชาติ
              ผ่านภาพต้นไม้ ป่าไม้ และภูมิทัศน์ทางอารมณ์ที่กึ่งจริงกึ่งจินตนาการ
            </p>
          </div>
        </div>
        ...
        <article className="mt-8 flex flex-col gap-5 text-ink2 leading-loose">
          <p>
            อักษรวิจิตร หงษ์ตัน หรือ &ldquo;บิวโคตรเสียว&rdquo; เป็นศิลปินร่วมสมัยชาวไทยที่สำรวจความสัมพันธ์ระหว่างมนุษย์กับธรรมชาติ
            ผ่านภาพต้นไม้ ป่าไม้ และภูมิทัศน์ทางอารมณ์กึ่งจริงกึ่งจินตนาการ แก่นของงานคือต้นไม้ไร้ใบที่ปรากฏซ้ำเสมอ —
            ไม่ใช่วัตถุในธรรมชาติ แต่เป็นภาพแทนของชีวิต การเติบโต การสูญเสีย และการดำรงอยู่ท่ามกลางความไม่แน่นอน
            รากที่หยั่งลึกคือความทรงจำและตัวตน กิ่งก้านที่แตกแขนงคือการเชื่อมโยงกับโลกที่กว้างใหญ่กว่าตนเอง
          </p>
          <p>
            ผลงานมักอยู่ในโทนสีน้ำเงินและเฉดสีเย็น สร้างบรรยากาศสงบนิ่ง ลึกลับ และเปี่ยมความรู้สึกทางจิตวิญญาณ
            ต้นไม้เดียวดาย หิ่งห้อยส่องแสง และพื้นที่ว่างอันกว้างใหญ่ เชื้อเชิญให้ผู้ชมเผชิญหน้ากับความเงียบ ความโดดเดี่ยว
            และความจริงพื้นฐานของชีวิต — การเปลี่ยนแปลง การจากลา และการยืนหยัดเพียงลำพัง สร้างสรรค์ด้วยสีน้ำมันบนผ้าใบ
            บางครั้งใช้สีอะคริลิกร่วมด้วย เคลื่อนไหวระหว่าง Landscape, Fantasy และ Emotional Landscape
          </p>
          <p className="text-ink" style={{ fontFamily: "var(--font-serif)" }}>
            สำหรับอักษรวิจิตร ต้นไม้ทุกต้นคือภาพเหมือนของมนุษย์ และป่าทุกผืนคือบทสนทนาระหว่างความโดดเดี่ยวกับการเชื่อมโยง
            ซึ่งยังคงดำเนินต่อไปอย่างไม่มีที่สิ้นสุด
          </p>
        </article>
      </section>
